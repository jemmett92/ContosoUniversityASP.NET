...
namespace ContosoUniversity.Tests
{
    ...
    public class SqlServerUnitTest1 : SqlDatabaseTestClass
    {
        ...
        {
            SqlDatabaseTestActions testActions = this.TestForStudentNameData;
            // Execute the pre-test script
            // 
            System.Diagnostics.Trace.WriteLineIf((testActions.PretestAction != null), "Executing pre-test script...");
            SqlExecutionResult[] pretestResults = TestService.Execute(this.PrivilegedContext, this.PrivilegedContext, testActions.PretestAction);
        ...
        private void InitializeComponent()
        {
            ...
            Microsoft.Data.Tools.Schema.Sql.UnitTesting.SqlDatabaseTestAction TestForStudentName_TestAction;
            ...
            this.TestForStudentNameData = new Microsoft.Data.Tools.Schema.Sql.UnitTesting.SqlDatabaseTestActions();
            SqlTest1_TestAction = new Microsoft.Data.Tools.Schema.Sql.UnitTesting.SqlDatabaseTestAction();
            inconclusiveCondition1 = new Microsoft.Data.Tools.Schema.Sql.UnitTesting.Conditions.InconclusiveCondition();
            TestForStudentName_TestAction = new Microsoft.Data.Tools.Schema.Sql.UnitTesting.SqlDatabaseTestAction();
            ...
            // 
            // TestForStudentNameData
            // 
            this.TestForStudentNameData.PosttestAction = null;
            this.TestForStudentNameData.PretestAction = null;
            this.TestForStudentNameData.TestAction = TestForStudentName_TestAction;
            // 
            // TestForStudentName_TestAction
            // 
            TestForStudentName_TestAction.Conditions.Add(inconclusiveCondition2);
            resources.ApplyResources(TestForStudentName_TestAction, "TestForStudentName_TestAction");
            // 
        ...
        private SqlDatabaseTestActions TestForStudentNameData;
    }
}
